...
public class Seed extends javax.swing.JFrame {
    ...
    public void total(){
        try{
        String str="select tprice from seed";   
        String str1="select * from seed";
        Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/farmerdata","root","");
        Statement stmt= conn.prepareStatement(str);
    ...
    {     try 
     ...
     public void disable()
    {   try{
        String str="select id,name,price,image from seed_data";   
        Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/farmerdata","root","");
        Statement stmt= conn.prepareStatement(str);
        String st1,st2,st3;
        ResultSet rs = stmt.executeQuery(str); 
    ...
    private void initComponents() {
        ...
        jPanel14.add(p1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 40, 134, 190));
        ...
        jPanel14.add(p2, new org.netbeans.lib.awtextra.AbsoluteConstraints(211, 36, 140, 190));
        ...
        jPanel14.add(p3, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 36, 136, 190));
        ...
        jPanel14.add(p4, new org.netbeans.lib.awtextra.AbsoluteConstraints(567, 36, -1, -1));
        ...
        jPanel14.add(p5, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 40, 134, 190));
        ...
        jPanel14.add(p6, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 260, 134, 190));
        ...
        jPanel14.add(p7, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 260, 134, 190));
        ...
        jPanel14.add(p8, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 270, 134, 190));
        ...
        jPanel14.add(p9, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 270, 134, 190));
        ...
        jPanel14.add(p10, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 270, 134, 190));

        getContentPane().add(jPanel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 900, 480));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 120, 320, -1));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 580, -1, -1));

        jLabel2.setText("TOTAL:");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1070, 560, -1, -1));

        total.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        getContentPane().add(total, new org.netbeans.lib.awtextra.AbsoluteConstraints(1110, 560, 60, 20));

        jLabel5.setText("EMAIL:");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 70, -1, -1));
        getContentPane().add(mail, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 64, 160, 20));
    ...
    private void p1bActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_p1bActionPerformed
        ...
        try
        {
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/farmerdata","root","");
            Statement stmt = con.createStatement();
            String q1 = "insert into seed values('"+st1+"','"+st2+"','"+st3+"','"+st5+"')";
            stmt.executeUpdate(q1); 
            total();
        }
        catch(Exception e)
   ...
   String st1=p9n.getText();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ferti.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
